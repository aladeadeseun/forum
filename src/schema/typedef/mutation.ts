export default `#graphql
  type Mutation{
    ...
    #Admin hide or show comment
    hideShowComment(commentId:ID!): HideShowCommentResponse! @checkCsrf @isloggedin(emailMustBeVerified: true, throwError:false) @haspermission(requires:[ADMIN, MODERATOR], throwError:false)
  }
`
